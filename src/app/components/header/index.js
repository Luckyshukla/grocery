            ...
            <div>
                <header className="header clearfix">
                            ...
                            <div className="row">
                                <div className="col-lg-12 text-center">
                                    <a href="/" className="mb-0 text-white">
                                        20% cashback for new users | Code: <strong><span className="text-light">Orgodoor13 <span className="mdi mdi-tag-faces" /></span> </strong>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <nav className="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu">
                        <div className="container-fluid">
                            <a className="navbar-brand" href="/" style={{color: '#fff'}}> Orgodoor </a>
